...
<contact@prestashop.com>
  ...
  * International Registered Trademark & Property of PrestaShop SA *} {block name='product_miniature_item'}
  <div class="product-card-mobile col-xs-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
        ...
        <div class="product-description">
          ...
          <div class="product-price-and-shipping">
            ...
            <!--  {if $product.discount_type === 'percentage'}
                 <span class="discount-percentage discount-product" style="top: 0px !important;">{$product.discount_percentage}</span>
            ...
            {hook h='displayProductPriceBlock' product=$product type='unit_price'} {hook h='displayProductPriceBlock' product=$product
            type='weight'}
          </div>
