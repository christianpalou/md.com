...
<contact@prestashop.com>
  ...
  * International Registered Trademark & Property of PrestaShop SA *} {block name='header_banner'}
  ...
  <nav class="header-nav">
    <div class="container">
      <div class="row">
        ...
        <div class="hidden-md-up text-sm-center mobile container-header">
          ...
          <div class="float-xs-right padding-search"
               id="_mobile_search">
            <div class="user-info">
