...
<contact@prestashop.com>
  ...
  * International Registered Trademark & Property of PrestaShop SA *}
  ...
  <body id="{$page.page_name}"
        class="{$page.body_classes|classnames}">
      ...
      <section id="wrapper">
        ...
        <div class="container-fluid">
          ...
          <div id="content-wrapper"
               class="left-column right-column col-sm-12 col-md-6 ">
    ...
    {block name='javascript_bottom'} {include file="_partials/javascript.tpl" javascript=$javascript.bottom} {/block} {block
    name='hook_before_body_closing_tag'} {hook h='displayBeforeBodyClosingTag'} {/block}
  </body>
